...
const testimonials = [
    {
        quote: "Found an amazing electrician within hours. The service was fantastic!",
        author: "Emily Wilson",
        role: "Homeowner",
...
const faqs = [
    {
        ...
        answer: "Simply search for your needed service, browse available professionals, and book directly through our platform. You can choose based on reviews, pricing, and availability.",
    },
    {
        question: "Are the professionals verified?",
        answer: "Yes, all professionals undergo thorough background checks and must provide proper certification and insurance documentation before joining our platform.",
    },
    {
        question: "What if I'm not satisfied with the service?",
        answer: "We offer a satisfaction guarantee. If you're not happy with the service, we'll work to resolve the issue or provide a refund according to our policy.",
    },
    {
        question: "How quickly can I find a professional?",
        answer: "Most users find suitable professionals within hours of posting their requirements. In urgent cases, we have professionals available for same-day service in many areas.",
    },
    {
        question: "Do you charge any booking fees?",
        answer: "We charge a small service fee that helps us maintain the platform and provide support services. The fee is transparent and shown before you confirm your booking.",
    },
];
            ...
            <AnimatedSection animation="slide-up" bgColor="primary">
                ...
                <div className="grid md:grid-cols-3 gap-12 mt-16">
                    {[
                        ...
                        <div
                            key={index}
                            className="bg-white/90 backdrop-blur-md rounded-lg p-8 text-center shadow-2xl transform hover:-translate-y-2 transition-transform duration-300"
                        >
                            <div className="rounded-full bg-blue-500/20 p-4 w-20 h-20 mx-auto mb-6 relative overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-blue-300 to-transparent rounded-full animate-spin-slow"></div>
                                <item.icon className="w-10 h-10 text-blue-600 absolute inset-0 m-auto" />
                            </div>
                ...
                <div className="container px-4 py-12 md:py-20">
                    <div className="grid md:grid-cols-6 gap-8">
                        <div className="md:col-span-2">
                            <div className="text-2xl font-bold mb-4">
                                <span className="text-primary">People</span>Work
                            </div>
                            <p className="text-muted-foreground mb-4">
                                Connecting skilled professionals with clients
                                who need their services. Quality work
                                guaranteed.
                            </p>
                    ...
                    <div className="mt-12 pt-6 border-t border-border/20 flex flex-col md:flex-row justify-between items-center">
                        <div className="text-sm text-muted-foreground mb-4 md:mb-0">
                            © 2024 PeopleWork. All rights reserved.
                        </div>
